...
data_complete <- data_clean %>% filter(species == c("acantho","ambon","chromis","humbug","lemon"))
...
ggplot(data, mapping = aes(x=treatment, y = activity)) +
  geom_point(aes(color=treatment))+facet_wrap(~species)
